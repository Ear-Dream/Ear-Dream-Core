...
현재 서빙 모델은 그 레포의 `single_observed_hand_300` — 「서빙 모델」 절 참고.
...
## 서빙 모델 — Single-Observed-Hand 300단어
...
자세가 학습 분포 안에 들어온다. 여기에 직접 촬영 데이터(3인)로 도메인 적응까지 얹혔다.
...
| 조건 | top-1 | top-4 |
| --- | ---: | ---: |
| **all_people (현재 서빙)** | **39.9%** | **69.6%** |
| final_deployment 번들 | 30.4% | 63.0% |
