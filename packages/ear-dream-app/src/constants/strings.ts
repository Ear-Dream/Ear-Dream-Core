...
export const strings = {
  ...
  signVideo: {
    ...
    /** 어휘엔 있지만 아바타 동작 자산이 아직 없는 단어(현재 259개). */
    notReadyWords: '이 단어는 수어 동작이 아직 준비되지 않았어요',
    /** 재생 가능한 단어가 하나도 없을 때. */
    nothingPlayable: '이 문장은 아직 수어로 보여드릴 수 없어요',
    /** 자산이 빠진 빌드 — 개발 환경에서만 나온다. */
    assetsMissing: '수어 동작 자산이 없습니다. pnpm setup:sign-sequences 로 생성하세요.',
    /** 서버와 자산 번들 판이 다름 — 조용히 틀린 걸 재생하면 안 된다. */
    bundleMismatch: '서버와 수어 동작 자산의 판본이 다릅니다. 자산을 다시 생성하세요.',
