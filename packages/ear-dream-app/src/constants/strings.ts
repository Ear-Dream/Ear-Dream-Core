...
export const strings = {
  ...
  signInput: {
    ...
    /**
     * ⚠️ 화면에서는 **지우기로 했다**(2026-08-25 요청) — 녹화 버튼 아래 문구가 없다.
     * 조작 방법을 알려 주던 유일한 **보이는** 안내라, 다시 필요해지면 여기서 되살린다.
     * 스크린 리더에는 위 `captureAlt` 로 여전히 전달된다.
     */
  ...
  signVideo: {
    ...
    replay: '다시보기',
    /**
     * 음성 입력 화면으로 되돌아간다 — 다시 말하려면 여기로 간다.
     * 시안에 이 화면의 뒤로가기가 없어 한동안 지웠던 경로인데, 요청(2026-08-25)으로
     * 「다시보기」와 나란한 두 버튼으로 되살렸다.
     */
    back: '뒤로',
