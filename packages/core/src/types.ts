...
// 좌표는 응답에 없다 — 클라이언트가 빌트인 시퀀스(public/sign-sequences/)으로 갖고 있고,
// 응답은 재생 순서와 시퀀스 조회 키(sequence_key)만 싣는다.
...
// 재생 불가 사유. unknown_word(어휘에 없음)와 no_sequence(어휘엔 있으나 시퀀스 없음)는
